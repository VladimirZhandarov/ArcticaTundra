...
RESOURCES += $$files(icegroupproc/*.qrc)

DEFINES += BUILD_ICEGROUPPROC_DLL _CRT_SECURE_NO_WARNINGS
...
FORMS += $$files(icegroupproc/ui/*.ui)
UI_HEADERS_DIR = icegroupproc
UI_SOURCES_DIR = ./

RC_FILE = icegroupproc/icegroupproc.rc
