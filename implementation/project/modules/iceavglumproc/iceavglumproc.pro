...
RESOURCES += $$files(iceavglumproc/*.qrc)

DEFINES += BUILD_ICEAVGLUMPROC_DLL _CRT_SECURE_NO_WARNINGS
...
FORMS += $$files(iceavglumproc/ui/*.ui)
UI_HEADERS_DIR = iceavglumproc
UI_SOURCES_DIR = ./

RC_FILE = iceavglumproc/iceavglumproc.rc
