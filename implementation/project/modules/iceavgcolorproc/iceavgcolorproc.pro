...
RESOURCES += $$files(iceavgcolorproc/*.qrc)

DEFINES += BUILD_ICEAVGCOLORPROC_DLL _CRT_SECURE_NO_WARNINGS
...
FORMS += $$files(iceavgcolorproc/ui/*.ui)
UI_HEADERS_DIR = iceavgcolorproc
UI_SOURCES_DIR = ./

RC_FILE = iceavgcolorproc/iceavgcolorproc.rc
